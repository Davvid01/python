...
def get_prompt_financial() -> object:
    ...
    '''
artykul="""Tesla's Earning news in text format: Tesla's earning this quarter blew all the estimates. They reported 4.5 billion $ profit against a revenue of 30 billion $. Their earnings per share was 2.3 $"""

print(extract_financial_data(artykul))
print(artykul)
